...
eat_sound = os.path.join(path, "sounds", "87535__whiprealgood__splat.wav")
background = pg.mixer.Sound(background_music)
background.set_volume(0.5)
background.play(loops=-1)
eat = pg.mixer.Sound(eat_sound)
eat.set_volume(0.3)
screen = pg.display.set_mode(SIZE)
FPS = 20
clock = pg.time.Clock()
score = Score(pos=(10, HEIGHT - 20))
bird_1 = Bird(pos=(WIDTH // 2, HEIGHT // 4), r=20, v=(0, 0), g=(0, 1), score=score, eat_sound=eat)
